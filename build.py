...
def build_flutter_dmg(version, features):
    ...
    system2('cp -rf ../target/release/service "./build/macos/Build/Products/Release/BCS Beam.app/Contents/MacOS/"')
    '''
    system2(
        "create-dmg --volname \"BCS Beam Installer\" --window-pos 200 120 --window-size 800 400 --icon-size 100 --app-drop-link 600 185 --icon \"BCS Beam.app\" 200 190 --hide-extension \"BCS Beam.app\" \"bcsbeam.dmg\" \"./build/macos/Build/Products/Release/BCS Beam.app\"")
    os.rename("bcsbeam.dmg", f"../bcsbeam-{version}.dmg")
    '''
    os.chdir("..")
